/* checksum : 428e15c3fcb5e488049c0bd8de905b7c */
@cds.external : true
...
entity OP_API_BUSINESS_PARTNER_SRV.A_BPCreditWorthiness {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
entity OP_API_BUSINESS_PARTNER_SRV.A_BPDataController {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
entity OP_API_BUSINESS_PARTNER_SRV.A_BPEmployment {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
entity OP_API_BUSINESS_PARTNER_SRV.A_BPFinancialServicesExtn {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
entity OP_API_BUSINESS_PARTNER_SRV.A_BPFinancialServicesReporting {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
entity OP_API_BUSINESS_PARTNER_SRV.A_BPFiscalYearInformation {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
entity OP_API_BUSINESS_PARTNER_SRV.A_BPIntlAddressVersion {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
entity OP_API_BUSINESS_PARTNER_SRV.A_BPRelationship {
  @sap.display.format : 'UpperCase'
  @sap.label : 'BP Relationship No.'
  @sap.quickinfo : 'BP Relationship Number'
  key RelationshipNumber : String(12) not null;
...
entity OP_API_BUSINESS_PARTNER_SRV.A_BPTaxCompliance {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
entity OP_API_BUSINESS_PARTNER_SRV.A_BusinessPartner {
  ...
  TradingPartner : String(6);
  @cds.ambiguous : 'missing on condition?'
  to_BPCreditWorthiness : Association to OP_API_BUSINESS_PARTNER_SRV.A_BPCreditWorthiness {  };
  @cds.ambiguous : 'missing on condition?'
  to_BPDataController : Association to many OP_API_BUSINESS_PARTNER_SRV.A_BPDataController {  };
  @cds.ambiguous : 'missing on condition?'
  to_BPEmployment : Association to many OP_API_BUSINESS_PARTNER_SRV.A_BPEmployment {  };
  @cds.ambiguous : 'missing on condition?'
  to_BPFinServicesReporting : Association to OP_API_BUSINESS_PARTNER_SRV.A_BPFinancialServicesReporting {  };
  @cds.ambiguous : 'missing on condition?'
  to_BPFiscalYearInformation : Association to many OP_API_BUSINESS_PARTNER_SRV.A_BPFiscalYearInformation {  };
  @cds.ambiguous : 'missing on condition?'
  to_BPRelationship : Association to many OP_API_BUSINESS_PARTNER_SRV.A_BPRelationship {  };
  @cds.ambiguous : 'missing on condition?'
  to_BPTaxCompliance : Association to many OP_API_BUSINESS_PARTNER_SRV.A_BPTaxCompliance {  };
  @cds.ambiguous : 'missing on condition?'
  ...
  @cds.ambiguous : 'missing on condition?'
  to_BusinessPartnerIsBank : Association to OP_API_BUSINESS_PARTNER_SRV.A_BusinessPartnerIsBank {  };
  @cds.ambiguous : 'missing on condition?'
  to_BusinessPartnerRating : Association to many OP_API_BUSINESS_PARTNER_SRV.A_BusinessPartnerRating {  };
  @cds.ambiguous : 'missing on condition?'
...
entity OP_API_BUSINESS_PARTNER_SRV.A_BusinessPartnerAlias {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
entity OP_API_BUSINESS_PARTNER_SRV.A_BusinessPartnerIsBank {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
entity OP_API_BUSINESS_PARTNER_SRV.A_BusinessPartnerPaymentCard {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
@sap.content.version : '1'
@sap.label : 'Ratings'
entity OP_API_BUSINESS_PARTNER_SRV.A_BusinessPartnerRating {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
