/* checksum : 9ee266e7be905bc21e82c72a4148e78b */
@cds.external : true
type OP_PURCHASEORDER_0001.SAP__Message {
...
entity OP_PURCHASEORDER_0001.POSubcontractingComponent {
  @Core.Immutable : true
  ...
  SAP__Messages : many OP_PURCHASEORDER_0001.SAP__Message not null;
  @cds.ambiguous : 'missing on condition?'
  _PurchaseOrder : Association to one OP_PURCHASEORDER_0001.PurchaseOrder on _PurchaseOrder.PurchaseOrder = PurchaseOrder;
  @cds.ambiguous : 'missing on condition?'
  _PurchaseOrderItem : Association to one OP_PURCHASEORDER_0001.PurchaseOrderItem {  };
  @cds.ambiguous : 'missing on condition?'
  _ScheduleLine : Association to one OP_PURCHASEORDER_0001.PurchaseOrderScheduleLine on _ScheduleLine.ScheduleLine = ScheduleLine;
};
...
@Capabilities.UpdateRestrictions.QueryOptions.SelectSupported : true
entity OP_PURCHASEORDER_0001.PurchaseOrder {
  @Core.Immutable : true
  @Common.IsUpperCase : true
  @Common.Label : 'Purchase Order'
  ...
  _PurchaseOrderItem : Composition of many OP_PURCHASEORDER_0001.PurchaseOrderItem;
  @cds.ambiguous : 'missing on condition?'
  @Common.Composition : true
  _PurchaseOrderNote : Composition of many OP_PURCHASEORDER_0001.PurchaseOrderNote;
  @cds.ambiguous : 'missing on condition?'
  @Common.Composition : true
  _PurchaseOrderPartner : Composition of many OP_PURCHASEORDER_0001.PurchaseOrderPartner;
  @cds.ambiguous : 'missing on condition?'
  @Common.Composition : true
  _SupplierAddress : Composition of one OP_PURCHASEORDER_0001.PurchaseOrderSupplierAddress;
};
...
@Capabilities.UpdateRestrictions.QueryOptions.SelectSupported : true
entity OP_PURCHASEORDER_0001.PurchaseOrderAccountAssignment {
  @Core.Immutable : true
  @Common.IsUpperCase : true
  @Common.Label : 'Purchasing Document'
  ...
  _PurchaseOrder : Association to one OP_PURCHASEORDER_0001.PurchaseOrder on _PurchaseOrder.PurchaseOrder = PurchaseOrder;
  @cds.ambiguous : 'missing on condition?'
  _PurchaseOrderItem : Association to one OP_PURCHASEORDER_0001.PurchaseOrderItem on _PurchaseOrderItem.PurchaseOrderItem = PurchaseOrderItem;
};
...
@Capabilities.DeleteRestrictions.Deletable : false
@Capabilities.UpdateRestrictions.QueryOptions.SelectSupported : true
entity OP_PURCHASEORDER_0001.PurchaseOrderInvoicingPlan {
  @Core.Immutable : true
  @Common.IsUpperCase : true
  @Common.Label : 'Purchase Order'
  @Common.Heading : 'Purchase Order Number'
  ...
  @cds.ambiguous : 'missing on condition?'
  @Common.Composition : true
  _POInvoicingPlanItem : Composition of many OP_PURCHASEORDER_0001.PurchaseOrderInvoicingPlanItem;
  @cds.ambiguous : 'missing on condition?'
  _PurchaseOrder : Association to one OP_PURCHASEORDER_0001.PurchaseOrder on _PurchaseOrder.PurchaseOrder = PurchaseOrder;
  @cds.ambiguous : 'missing on condition?'
  _PurchaseOrderItem : Association to one OP_PURCHASEORDER_0001.PurchaseOrderItem on _PurchaseOrderItem.PurchaseOrderItem = PurchaseOrderItem;
...
@Capabilities.UpdateRestrictions.QueryOptions.SelectSupported : true
entity OP_PURCHASEORDER_0001.PurchaseOrderInvoicingPlanItem {
  @Core.Immutable : true
  @Common.IsUpperCase : true
  @Common.Label : 'Purchase Order'
  @Common.Heading : 'Purchase Order Number'
  ...
  _PurchaseOrder : Association to one OP_PURCHASEORDER_0001.PurchaseOrder on _PurchaseOrder.PurchaseOrder = PurchaseOrder;
  @cds.ambiguous : 'missing on condition?'
  _PurchaseOrderInvoicingPlan : Association to one OP_PURCHASEORDER_0001.PurchaseOrderInvoicingPlan on _PurchaseOrderInvoicingPlan.InvoicingPlan = InvoicingPlan;
  @cds.ambiguous : 'missing on condition?'
  _PurchaseOrderItem : Association to one OP_PURCHASEORDER_0001.PurchaseOrderItem {  };
};
...
@Capabilities.UpdateRestrictions.QueryOptions.SelectSupported : true
entity OP_PURCHASEORDER_0001.PurchaseOrderItem {
  @Core.Immutable : true
  @Common.IsUpperCase : true
  @Common.Label : 'Purchase Order'
  @Common.Heading : 'Purchase Order Number'
  ...
  @cds.ambiguous : 'missing on condition?'
  @Common.Composition : true
  _DeliveryAddress : Composition of one OP_PURCHASEORDER_0001.PurOrderItemDeliveryAddress;
  @cds.ambiguous : 'missing on condition?'
  _PurchaseOrder : Association to one OP_PURCHASEORDER_0001.PurchaseOrder on _PurchaseOrder.PurchaseOrder = PurchaseOrder;
  @cds.ambiguous : 'missing on condition?'
  @Common.Composition : true
  _PurchaseOrderInvoicingPlan : Composition of many OP_PURCHASEORDER_0001.PurchaseOrderInvoicingPlan;
  @cds.ambiguous : 'missing on condition?'
  @Common.Composition : true
  _PurchaseOrderItemNote : Composition of many OP_PURCHASEORDER_0001.PurchaseOrderItemNote;
  @cds.ambiguous : 'missing on condition?'
  @Common.Composition : true
  _PurchaseOrderScheduleLineTP : Composition of many OP_PURCHASEORDER_0001.PurchaseOrderScheduleLine;
  @cds.ambiguous : 'missing on condition?'
  @Common.Composition : true
  _PurOrdAccountAssignment : Composition of many OP_PURCHASEORDER_0001.PurchaseOrderAccountAssignment;
  @cds.ambiguous : 'missing on condition?'
  @Common.Composition : true
  _PurOrdPricingElement : Composition of many OP_PURCHASEORDER_0001.PurOrderItemPricingElement;
};
...
@Capabilities.UpdateRestrictions.QueryOptions.SelectSupported : true
entity OP_PURCHASEORDER_0001.PurchaseOrderItemNote {
  @Core.Immutable : true
  @Common.IsUpperCase : true
  @Common.Label : 'Purchase Order'
  @Common.Heading : 'Purchase Order Number'
...
@Capabilities.UpdateRestrictions.Updatable : false
@Capabilities.UpdateRestrictions.QueryOptions.SelectSupported : true
entity OP_PURCHASEORDER_0001.PurchaseOrderNote {
  @Core.Immutable : true
  @Common.IsUpperCase : true
  @Common.Label : 'Purchase Order'
  @Common.Heading : 'Purchase Order Number'
...
@Capabilities.UpdateRestrictions.Updatable : false
@Capabilities.UpdateRestrictions.QueryOptions.SelectSupported : true
entity OP_PURCHASEORDER_0001.PurchaseOrderPartner {
  @Core.Immutable : true
  @Common.IsUpperCase : true
  @Common.Label : 'Purchasing Document'
  @Common.Heading : 'Pur. Doc.'
  ...
  @cds.ambiguous : 'missing on condition?'
  _PurchaseOrderTP : Association to one OP_PURCHASEORDER_0001.PurchaseOrder on _PurchaseOrderTP.PurchaseOrder = PurchaseOrder;
};
...
@Capabilities.UpdateRestrictions.QueryOptions.SelectSupported : true
entity OP_PURCHASEORDER_0001.PurchaseOrderScheduleLine {
  @Core.Immutable : true
  @Common.IsUpperCase : true
  @Common.Label : 'Purchasing Document'
  @Common.Heading : 'Pur. Doc.'
  ...
  @cds.ambiguous : 'missing on condition?'
  @Common.Composition : true
  _SubcontractingComponent : Composition of many OP_PURCHASEORDER_0001.POSubcontractingComponent;
};
...
@Capabilities.UpdateRestrictions.QueryOptions.SelectSupported : true
entity OP_PURCHASEORDER_0001.PurchaseOrderSupplierAddress {
  @Core.Immutable : true
  @Common.IsUpperCase : true
  @Common.Label : 'Address Number'
  @Common.Heading : 'Addr. No.'
...
@Capabilities.UpdateRestrictions.QueryOptions.SelectSupported : true
entity OP_PURCHASEORDER_0001.PurOrderItemDeliveryAddress {
  @Core.Immutable : true
  @Common.IsUpperCase : true
  @Common.Label : 'Purchasing Document'
  @Common.Heading : 'Pur. Doc.'
...
@Capabilities.UpdateRestrictions.QueryOptions.SelectSupported : true
entity OP_PURCHASEORDER_0001.PurOrderItemPricingElement {
  @Core.Immutable : true
  @Common.IsUpperCase : true
  @Common.Label : 'Purchasing Document'
  @Common.Heading : 'Pur. Doc.'
